  ...
  _createClass(MockWsGenerator, [{
    ...
    value: function () {
      var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(calls, respDatabase) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 3;
                _iterator = Object.keys(this.calls)[Symbol.iterator]();
        ...
        }, _callee2, this, [[3, 89, 93, 101], [11, 72, 76, 84], [21, 55, 59, 67], [60,, 62, 66], [77,, 79, 83], [94,, 96, 100]]);
      }));
    ...
    value: function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(event, respDatabase, option) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 7:
                ...
                this.handleDataSharing(data);
                finished = this.handleSubscriptionLimits(data, reqDef.data, option);
    ...
    value: function handleSubscriptionLimits(data, defData, option) {
      defData.push(data);
